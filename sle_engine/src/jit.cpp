...
[[maybe_unused]] constexpr std::uint8_t kRbx = 3;
constexpr std::uint8_t kRsp = 4;
[[maybe_unused]] constexpr std::uint8_t kRbp = 5;
constexpr std::uint8_t kRsi = 6;
constexpr std::uint8_t kRdi = 7;
[[maybe_unused]] constexpr std::uint8_t kR8 = 8;
[[maybe_unused]] constexpr std::uint8_t kR9 = 9;
[[maybe_unused]] constexpr std::uint8_t kR10 = 10;
